		...
		public override void OnInspectorGUI() {
			...
			if (s.mode == SettingsMode.Mesh) {
				...
				if (s.removeParticles) {
					...
					ShowHint("Speed at which particles fade out. 1 means instant fade out, 0 means no fade out.");
					s.fadeOutSpeed = EditorGUILayout.Slider("Fade out speed", s.fadeOutSpeed, 0f, 1f);
